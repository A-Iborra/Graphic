...
#include "Function.h"
   ...
   Function::_IConnectionPoint::_IConnectionPoint(Function *pp,REFIID outgoingIFace) : 
      pParent(pp), 
      adviseSink(0),
      nextCookie(400),
      refCount(1),
   ...
   Function::_IConnectionPoint::~_IConnectionPoint() {
   delete [] connections;
   countConnections = 0;
   return;
   }
   ...
   HRESULT Function::_IConnectionPoint::QueryInterface(REFIID riid,void **ppv) {
   *ppv = NULL; 
   ...
   STDMETHODIMP_(ULONG) Function::_IConnectionPoint::AddRef() {
   return ++refCount;
   }
 

   STDMETHODIMP_(ULONG) Function::_IConnectionPoint::Release() {
   if ( 0 == --refCount ) {
      delete this;
      return 0;
   }
   ...
   STDMETHODIMP Function::_IConnectionPoint::GetConnectionInterface(IID *pIID) {
   ...
   *pIID = outGoingInterfaceType;
   ...
   STDMETHODIMP Function::_IConnectionPoint::GetConnectionPointContainer(IConnectionPointContainer **ppCPC) {
   return pParent -> QueryInterface(IID_IConnectionPointContainer,(void **)ppCPC);
   }
 
 
   STDMETHODIMP Function::_IConnectionPoint::Advise(IUnknown *pUnkSink,DWORD *pdwCookie) {

   IGSFunctioNaterEvents* pIEvents = 0;
   ...
   *pdwCookie = 0;
   ...
   connections[freeSlot].pUnk = pIEvents;
   ...
   *pdwCookie = nextCookie++;
   ...
   STDMETHODIMP Function::_IConnectionPoint::Unadvise(DWORD dwCookie) {
   ...
   STDMETHODIMP Function::_IConnectionPoint::EnumConnections(IEnumConnections **ppEnum) {
   ...
   *ppEnum = NULL;
   ...
   int Function::_IConnectionPoint::getSlot() {
   ...
   int Function::_IConnectionPoint::findSlot(DWORD dwCookie) {
