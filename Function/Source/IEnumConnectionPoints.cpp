...
#include "Function.h"
  ...
  Function::_IEnumConnectionPoints::_IEnumConnectionPoints(Function *pp,_IConnectionPoint **cp,int connectionPointCount) : 
  ...
  Function::_IEnumConnectionPoints::~_IEnumConnectionPoints() { 
  for ( int k = 0; k < cpCount; k++ )
  ...
  HRESULT Function::_IEnumConnectionPoints::QueryInterface(REFIID riid,void **ppv) {
  *ppv = NULL;
  ...
  *ppv = (void *)(this);
  ...
  unsigned long __stdcall Function::_IEnumConnectionPoints::AddRef() {
  return pParent -> AddRef();
  }

  unsigned long __stdcall Function::_IEnumConnectionPoints::Release() {
  return pParent -> Release();
  }


  HRESULT Function::_IEnumConnectionPoints::Next(ULONG countRequested,IConnectionPoint **rgpcn,ULONG *pcFetched) {
  ULONG found;
  ...
  HRESULT Function::_IEnumConnectionPoints::Skip(ULONG cSkip) {
  ...
  HRESULT Function::_IEnumConnectionPoints::Reset() {
  enumeratorIndex = 0;
  return S_OK;
  }

  HRESULT Function::_IEnumConnectionPoints::Clone(IEnumConnectionPoints **ppEnum) {
