...
#include "Evaluator.h"
   ...
   Evaluator::_IEnumConnectionPoints::~_IEnumConnectionPoints() { 
   for ( int k = 0; k < cpCount; k++ )
   ...
   HRESULT Evaluator::_IEnumConnectionPoints::QueryInterface(REFIID riid,void **ppv) {
   *ppv = NULL;
   ...
   *ppv = (void *)(this);
   ...
   unsigned long __stdcall Evaluator::_IEnumConnectionPoints::AddRef() {
   return pParent -> AddRef();
   }
 
   unsigned long __stdcall Evaluator::_IEnumConnectionPoints::Release() {
   return pParent -> Release();
   }
 
 
   HRESULT Evaluator::_IEnumConnectionPoints::Next(ULONG countRequested,IConnectionPoint **rgpcn,ULONG *pcFetched) {
   ULONG found;
   ...
   HRESULT Evaluator::_IEnumConnectionPoints::Skip(ULONG cSkip) {
   ...
   HRESULT Evaluator::_IEnumConnectionPoints::Reset() {
   enumeratorIndex = 0;
   return S_OK;
   }
 
   HRESULT Evaluator::_IEnumConnectionPoints::Clone(IEnumConnectionPoints **ppEnum) {
