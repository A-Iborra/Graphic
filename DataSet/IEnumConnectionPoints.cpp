...
#include "DataSet.h"
  ...
  DataSet::_IEnumConnectionPoints::_IEnumConnectionPoints(DataSet *pp,_IConnectionPoint **cp,int connectionPointCount) : 
  ...
  DataSet::_IEnumConnectionPoints::~_IEnumConnectionPoints() { 
  for ( int k = 0; k < cpCount; k++ )
  ...
  HRESULT DataSet::_IEnumConnectionPoints::QueryInterface(REFIID riid,void **ppv) {
  *ppv = NULL;
  ...
  *ppv = (void *)(this);
  ...
  unsigned long __stdcall DataSet::_IEnumConnectionPoints::AddRef() {
  return pParent -> AddRef();
  }

  unsigned long __stdcall DataSet::_IEnumConnectionPoints::Release() {
  return pParent -> Release();
  }


  HRESULT DataSet::_IEnumConnectionPoints::Next(ULONG countRequested,IConnectionPoint **rgpcn,ULONG *pcFetched) {
  ULONG found;
  ...
  HRESULT DataSet::_IEnumConnectionPoints::Skip(ULONG cSkip) {
  ...
  HRESULT DataSet::_IEnumConnectionPoints::Reset() {
  enumeratorIndex = 0;
  return S_OK;
  }

  HRESULT DataSet::_IEnumConnectionPoints::Clone(IEnumConnectionPoints **ppEnum) {
