...
#include "DataSet.h"
   ...
   DataSet::_IEnumerateConnections::_IEnumerateConnections(
             IUnknown* pHostObj,
             ULONG cConnections,
...
;//      if ( connections[i].pUnk ) connections[i].pUnk -> Release();
   ...
   STDMETHODIMP DataSet::_IEnumerateConnections::QueryInterface(REFIID riid,void **ppv) {
   *ppv = NULL;
   ...
   *ppv = (LPVOID)this;
   ...
   STDMETHODIMP_(ULONG) DataSet::_IEnumerateConnections::AddRef() {
   ...
   STDMETHODIMP_(ULONG) DataSet::_IEnumerateConnections::Release() {
   ...
   STDMETHODIMP DataSet::_IEnumerateConnections::Next(ULONG countRequested,CONNECTDATA* pConnections,ULONG* countEnumerated) {
   ULONG countReturned;
   ...
   STDMETHODIMP DataSet::_IEnumerateConnections::Skip(ULONG cSkip) {
   ...
   STDMETHODIMP DataSet::_IEnumerateConnections::Reset() {
   enumeratorIndex = 0;
   return S_OK;
   }
   ...
   STDMETHODIMP DataSet::_IEnumerateConnections::Clone(IEnumConnections** ppIEnum) {
